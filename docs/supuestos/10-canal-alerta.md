...
**Alimentado con lluvia real de IDEAM** (estación Kennedy; ver
[docs/10-validacion.md](../10-validacion.md)). El modelo de embalses es defendible pero
no está validado contra un desborde real.
...
| Drenaje del canal | 1,0 (tasa fija) | Calibrado para el aguacero sintético | **Subestima eventos reales cortos e intensos** (ver validación). |

**Hallazgo de validación:** con la lluvia real de oct–nov 2024, el canal **no desborda**
(máx 27 %). Es un hallazgo, no un bug: la hidráulica estaba calibrada para el aguacero
sintético de 40 mm/h. Detalle en docs/10-validacion.md.
